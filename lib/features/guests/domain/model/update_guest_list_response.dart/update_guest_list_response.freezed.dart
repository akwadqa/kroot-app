...
mixin _$UpdateGuestListRespone {
  ...
  $UpdateGuestListResponeCopyWith<UpdateGuestListRespone> get copyWith =>
      _$UpdateGuestListResponeCopyWithImpl<UpdateGuestListRespone>(
        this as UpdateGuestListRespone,
        _$identity,
      );
  ...
  int get hashCode => Object.hash(
    ...
    addedCount,
    skippedCount,
    const DeepCollectionEquality().hash(addedInvitees),
  );
...
abstract mixin class $UpdateGuestListResponeCopyWith<$Res> {
  factory $UpdateGuestListResponeCopyWith(
    UpdateGuestListRespone value,
  ...
  $Res call({
    ...
    return _then(
      _self.copyWith(
        ...
        addedCount: null == addedCount ? _self.addedCount : addedCount as int,
        skippedCount: null == skippedCount
            ? _self.skippedCount
            : skippedCount as int,
        addedInvitees: null == addedInvitees
            ? _self.addedInvitees
            : addedInvitees as List<AddedInvitee>,
      ),
    );
  }
}
...
class _UpdateGuestListRespone implements UpdateGuestListRespone {
  ...
  int get hashCode => Object.hash(
    ...
    addedCount,
    skippedCount,
    const DeepCollectionEquality().hash(_addedInvitees),
  );
...
abstract mixin class _$UpdateGuestListResponeCopyWith<$Res>
    implements $UpdateGuestListResponeCopyWith<$Res> {
  factory _$UpdateGuestListResponeCopyWith(
    _UpdateGuestListRespone value,
...
abstract mixin class $AddedInviteeCopyWith<$Res> {
  factory $AddedInviteeCopyWith(
    AddedInvitee value,
    $Res Function(AddedInvitee) _then,
...
abstract mixin class _$AddedInviteeCopyWith<$Res>
  ...
  factory _$AddedInviteeCopyWith(
    _AddedInvitee value,
    $Res Function(_AddedInvitee) _then,
