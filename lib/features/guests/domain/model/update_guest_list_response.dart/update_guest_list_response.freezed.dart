...
@JsonKey(name: 'occasion_id') String get occasionId;@JsonKey(name: 'added_count') int get addedCount;@JsonKey(name: 'skipped_count') int get skippedCount;@JsonKey(name: 'added_invitees') List<AddedInvitee> get addedInvitees;
/// Create a copy of UpdateGuestListRespone
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UpdateGuestListResponeCopyWith<UpdateGuestListRespone> get copyWith => _$UpdateGuestListResponeCopyWithImpl<UpdateGuestListRespone>(this as UpdateGuestListRespone, _$identity);
...
abstract mixin class $UpdateGuestListResponeCopyWith<$Res>  {
  factory $UpdateGuestListResponeCopyWith(UpdateGuestListRespone value, $Res Function(UpdateGuestListRespone) _then) = _$UpdateGuestListResponeCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: 'occasion_id') String occasionId,@JsonKey(name: 'added_count') int addedCount,@JsonKey(name: 'skipped_count') int skippedCount,@JsonKey(name: 'added_invitees') List<AddedInvitee> addedInvitees
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UpdateGuestListRespone value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UpdateGuestListRespone value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UpdateGuestListRespone value)?  $default,){
final _that = this;
switch (_that) {
case _UpdateGuestListRespone() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'occasion_id')  String occasionId, @JsonKey(name: 'added_count')  int addedCount, @JsonKey(name: 'skipped_count')  int skippedCount, @JsonKey(name: 'added_invitees')  List<AddedInvitee> addedInvitees)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateGuestListRespone() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'occasion_id')  String occasionId, @JsonKey(name: 'added_count')  int addedCount, @JsonKey(name: 'skipped_count')  int skippedCount, @JsonKey(name: 'added_invitees')  List<AddedInvitee> addedInvitees)  $default,) {final _that = this;
switch (_that) {
case _UpdateGuestListRespone():
return $default(_that.occasionId,_that.addedCount,_that.skippedCount,_that.addedInvitees);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'occasion_id')  String occasionId, @JsonKey(name: 'added_count')  int addedCount, @JsonKey(name: 'skipped_count')  int skippedCount, @JsonKey(name: 'added_invitees')  List<AddedInvitee> addedInvitees)?  $default,) {final _that = this;
switch (_that) {
case _UpdateGuestListRespone() when $default != null:
return $default(_that.occasionId,_that.addedCount,_that.skippedCount,_that.addedInvitees);case _:
  return null;
...
class _UpdateGuestListRespone implements UpdateGuestListRespone {
  const _UpdateGuestListRespone({@JsonKey(name: 'occasion_id') required this.occasionId, @JsonKey(name: 'added_count') required this.addedCount, @JsonKey(name: 'skipped_count') required this.skippedCount, @JsonKey(name: 'added_invitees') required final  List<AddedInvitee> addedInvitees}): _addedInvitees = addedInvitees;
  factory _UpdateGuestListRespone.fromJson(Map<String, dynamic> json) => _$UpdateGuestListResponeFromJson(json);
...
@override@JsonKey(name: 'added_invitees') List<AddedInvitee> get addedInvitees {
...
@pragma('vm:prefer-inline')
_$UpdateGuestListResponeCopyWith<_UpdateGuestListRespone> get copyWith => __$UpdateGuestListResponeCopyWithImpl<_UpdateGuestListRespone>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UpdateGuestListResponeToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpdateGuestListRespone&&(identical(other.occasionId, occasionId) || other.occasionId == occasionId)&&(identical(other.addedCount, addedCount) || other.addedCount == addedCount)&&(identical(other.skippedCount, skippedCount) || other.skippedCount == skippedCount)&&const DeepCollectionEquality().equals(other._addedInvitees, _addedInvitees));
}
...
/// @nodoc
abstract mixin class _$UpdateGuestListResponeCopyWith<$Res> implements $UpdateGuestListResponeCopyWith<$Res> {
  factory _$UpdateGuestListResponeCopyWith(_UpdateGuestListRespone value, $Res Function(_UpdateGuestListRespone) _then) = __$UpdateGuestListResponeCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'occasion_id') String occasionId,@JsonKey(name: 'added_count') int addedCount,@JsonKey(name: 'skipped_count') int skippedCount,@JsonKey(name: 'added_invitees') List<AddedInvitee> addedInvitees
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AddedInviteeCopyWith<AddedInvitee> get copyWith => _$AddedInviteeCopyWithImpl<AddedInvitee>(this as AddedInvitee, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddedInvitee&&(identical(other.inviteeId, inviteeId) || other.inviteeId == inviteeId)&&(identical(other.fullName, fullName) || other.fullName == fullName));
}
...
abstract mixin class $AddedInviteeCopyWith<$Res>  {
  factory $AddedInviteeCopyWith(AddedInvitee value, $Res Function(AddedInvitee) _then) = _$AddedInviteeCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$AddedInviteeCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AddedInvitee value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AddedInvitee value)  $default,){
final _that = this;
switch (_that) {
case _AddedInvitee():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AddedInvitee value)?  $default,){
final _that = this;
switch (_that) {
case _AddedInvitee() when $default != null:
return $default(_that);case _:
...
class _AddedInvitee implements AddedInvitee {
  const _AddedInvitee({@JsonKey(name: 'invitee_id') required this.inviteeId, @JsonKey(name: 'full_name') required this.fullName});
  factory _AddedInvitee.fromJson(Map<String, dynamic> json) => _$AddedInviteeFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$AddedInviteeCopyWith<_AddedInvitee> get copyWith => __$AddedInviteeCopyWithImpl<_AddedInvitee>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AddedInviteeToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AddedInvitee&&(identical(other.inviteeId, inviteeId) || other.inviteeId == inviteeId)&&(identical(other.fullName, fullName) || other.fullName == fullName));
}
...
/// @nodoc
abstract mixin class _$AddedInviteeCopyWith<$Res> implements $AddedInviteeCopyWith<$Res> {
  factory _$AddedInviteeCopyWith(_AddedInvitee value, $Res Function(_AddedInvitee) _then) = __$AddedInviteeCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'invitee_id') String inviteeId,@JsonKey(name: 'full_name') String fullName
});
