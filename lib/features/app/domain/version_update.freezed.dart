...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'android_version')  String appAndroidVersion, @JsonKey(name: 'ios_version')  String appIosVersion, @JsonKey(name: 'app_update_required')  bool? appUpdateRequired, @JsonKey(name: 'app_update_message')  String? appUpdateMessage, @JsonKey(name: 'app_ios_url')  String? appIosUrl, @JsonKey(name: 'app_android_url')  String? appAndroidUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VersionUpdate() when $default != null:
return $default(_that.appAndroidVersion,_that.appIosVersion,_that.appUpdateRequired,_that.appUpdateMessage,_that.appIosUrl,_that.appAndroidUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'android_version')  String appAndroidVersion, @JsonKey(name: 'ios_version')  String appIosVersion, @JsonKey(name: 'app_update_required')  bool? appUpdateRequired, @JsonKey(name: 'app_update_message')  String? appUpdateMessage, @JsonKey(name: 'app_ios_url')  String? appIosUrl, @JsonKey(name: 'app_android_url')  String? appAndroidUrl)  $default,) {final _that = this;
switch (_that) {
case _VersionUpdate():
return $default(_that.appAndroidVersion,_that.appIosVersion,_that.appUpdateRequired,_that.appUpdateMessage,_that.appIosUrl,_that.appAndroidUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'android_version')  String appAndroidVersion, @JsonKey(name: 'ios_version')  String appIosVersion, @JsonKey(name: 'app_update_required')  bool? appUpdateRequired, @JsonKey(name: 'app_update_message')  String? appUpdateMessage, @JsonKey(name: 'app_ios_url')  String? appIosUrl, @JsonKey(name: 'app_android_url')  String? appAndroidUrl)?  $default,) {final _that = this;
switch (_that) {
case _VersionUpdate() when $default != null:
return $default(_that.appAndroidVersion,_that.appIosVersion,_that.appUpdateRequired,_that.appUpdateMessage,_that.appIosUrl,_that.appAndroidUrl);case _:
  return null;
