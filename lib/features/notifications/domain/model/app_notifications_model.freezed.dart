...
mixin _$AppNotificationsModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, appMessageId, appMessageTitle,
      appMessageIcon, type, item, publishedOn, expiryDate, content);
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      appMessageId: null == appMessageId
          ? _self.appMessageId
          : appMessageId // ignore: cast_nullable_to_non_nullable
              as String,
      appMessageTitle: freezed == appMessageTitle
          ? _self.appMessageTitle
          : appMessageTitle // ignore: cast_nullable_to_non_nullable
              as String?,
      appMessageIcon: freezed == appMessageIcon
          ? _self.appMessageIcon
          : appMessageIcon // ignore: cast_nullable_to_non_nullable
              as String?,
      type: null == type
          ? _self.type
