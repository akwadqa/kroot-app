...
mixin _$UtilsResponse {
 ...
 SubscriberModel? get subscriber;@JsonKey(name: 'event_types') List<String>? get eventTypes;@JsonKey(name: 'bundles') List<BundleModel>? get bundles;@JsonKey(name: 'invite_templates') List<TemplateModel>? get templates;
