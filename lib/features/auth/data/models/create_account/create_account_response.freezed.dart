...
mixin _$CreateAccountResponse {
  ...
  $CreateAccountResponseCopyWith<CreateAccountResponse> get copyWith =>
      _$CreateAccountResponseCopyWithImpl<CreateAccountResponse>(
          this as CreateAccountResponse, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CreateAccountResponse &&
  ...
  int get hashCode => Object.hash(
      runtimeType, user_id, first_name, last_name, email, mobile_no);
...
abstract mixin class $CreateAccountResponseCopyWith<$Res> {
  factory $CreateAccountResponseCopyWith(CreateAccountResponse value,
          $Res Function(CreateAccountResponse) _then) =
      _$CreateAccountResponseCopyWithImpl;
  @useResult
  $Res call(
      {String? user_id,
      String? first_name,
...
extension CreateAccountResponsePatterns on CreateAccountResponse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CreateAccountResponse value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? user_id, String? first_name, String? last_name,
    ...
    switch (_that) {
      case _CreateAccountResponse() when $default != null:
        return $default(_that.user_id, _that.first_name, _that.last_name,
            _that.email, _that.mobile_no);
      case _:
        return orElse();
    }
  }
...
class _CreateAccountResponse implements CreateAccountResponse {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CreateAccountResponseCopyWith<_CreateAccountResponse> get copyWith =>
      __$CreateAccountResponseCopyWithImpl<_CreateAccountResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CreateAccountResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CreateAccountResponse &&
            (identical(other.user_id, user_id) || other.user_id == user_id) &&
            (identical(other.first_name, first_name) ||
                other.first_name == first_name) &&
            (identical(other.last_name, last_name) ||
...
/// @nodoc
abstract mixin class _$CreateAccountResponseCopyWith<$Res>
    implements $CreateAccountResponseCopyWith<$Res> {
  factory _$CreateAccountResponseCopyWith(_CreateAccountResponse value,
          $Res Function(_CreateAccountResponse) _then) =
      __$CreateAccountResponseCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? user_id,
